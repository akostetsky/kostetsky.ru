...
BLOG_AUTHOR = "Alexander Kostetsky"  # (translatable)
BLOG_TITLE = "Alexander Kostetsky"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://kostetsky.ru/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://kostetskiy.ru/"
BLOG_EMAIL = "alexander@kostetsky.ru"
BLOG_DESCRIPTION = {"en": "My place to share some thoughts with the world.",
                    "ru": "Мое место, чтобы поделиться мыслями с миром."}  # (translatable)
...
REDIRECTIONS = [ 
    ("stories/about/index.html", "pages/about/index.html")
]
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         {author} - Powered by         Nikola         {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "alexanderkostetskiy"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://github.com/akostetsky', 'My Github', 'icon-github'),
      )
}
